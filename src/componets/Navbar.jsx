...
<nav className="bg-dark-80 px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
  <div className="container flex flex-wrap items-center justify-between mx-auto">
    <div className="flex md:order-2">
      <button type="button" className="text-slate-100 bg-white opacity-25 hover:bg-white opacity-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
    ...
    <a href="https://flowbite.com/" className="flex items-center">
      <img src="https://play.hbomax.com/40f1ec3e7380accdae648d90d4366e8f.png" className="h-6 mr-3 sm:h-9" alt="HBOmax Logo" />
    </a>
